              ...
              <div key={w._id} className="group relative overflow-hidden rounded-[2rem] bg-[#161618] p-6 transition-all hover:bg-[#1c1c1e] border border-white/5 hover:border-purple-500/20 hover:shadow-lg hover:shadow-purple-900/10">
                ...
                <div className="mb-4 flex items-start justify-between relative z-10">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="rounded-full bg-purple-500/10 p-3 text-purple-400 group-hover:bg-purple-500 group-hover:text-white transition-colors"
                ...
                {showActionsMap[w._id] && (
                  <div className="sm:hidden flex flex-col items-end gap-2 mb-3 smooth-all">
                    ...
                    <Link
                      href={`/wishlist/${w._id}/edit`}
                      className="rounded-full bg-zinc-500/10 p-3 text-zinc-400 hover:bg-zinc-500 hover:text-white transition-colors"
                      title="Edit Wishlist"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19l-4 1 1-4Z"/></svg>
                    </Link>
